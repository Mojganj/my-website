...
export default function AboutMe(props) {
  const technologies = [
    ["JavaScript (ES6+)", "Next.js", "React.js", "Node.js"  ],
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                codes that thrive on the internet. Since pursuing my engineering degree, my career has taken me
                through diverse industries, allowing me to refine my expertise
                in desktop and web development.
              </span>
            </div>
            <div className="font-Header ">
              <span className="text-gray-400 ">
                 I am adept at handling everything
                from user interface design and user experience optimization to 
                server-side logic, database interactions, and API integrations. 
                My ability to work on both client and server-side coding, along with 
                my understanding of development tools, version control systems like Git,
                and agile methodologies, enables me to deliver robust, high-quality solutions.
              </span>
            </div>
